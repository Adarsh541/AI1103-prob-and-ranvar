...
\begin{align}
    ...
    &=0\label{9}
\end{align}
From $\eqref{9}$ and property on multivariate normal distribution stated above it follows that $\overline{X}$ and $X=\brak{X_1-\overline{X},....,X_n-\overline{X}}^T$ are independent normal vectors,and so $\overline{X}$ is independent of $X^TX=(n-1)S^2$
\end{document}
